...
urlpatterns = (
    ...
    path("Formularios/Pregunta/", views.PreguntaListView.as_view(), name="Formularios_Pregunta_list"),
    ...
    path("Formularios/Formulario/", views.FormularioListView.as_view(), name="Formularios_Formulario_list"),
    path("Formularios/Formulario/create/", views.FormularioCreateView.as_view(), name="Formularios_Formulario_create"),
