...
from apps.Seguimientos.models import Seguimiento
from apps.Planes.models import PlanInversion, PlanProceso, TipoPlanEspecifico, TipoPlan
from apps.Formularios.models import Formulario
from apps.Planes.models import PlanInversion
from apps.Seguimientos.models import Seguimiento
from apps.Departamentos.models import Oficina
from apps.Planes.models import PlanDesarrollo
from apps.Formularios.models import Formulario
from apps.Planes.models import PlanEstrategico
from apps.Planes.models import PlanProceso
from . import models
