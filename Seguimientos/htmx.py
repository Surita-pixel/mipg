...
class HTMXFormulario_SeguimientoListView(generic.ListView):
...
class HTMXFormulario_SeguimientoCreateView(generic.CreateView):
    model = models.Formulario_Seguimiento
    form_class = forms.Formulario_SeguimientoForm
...
class HTMXFormulario_SeguimientoDeleteView(generic.DeleteView):
    model = models.Formulario_Seguimiento
    success_url = reverse_lazy("app_Formulario_Seguimiento_htmx_list")
...
class HTMXSeguimientoListView(generic.ListView):
...
class HTMXSeguimientoCreateView(generic.CreateView):
    model = models.Seguimiento
    form_class = forms.SeguimientoForm
...
class HTMXSeguimientoDeleteView(generic.DeleteView):
    model = models.Seguimiento
    success_url = reverse_lazy("app_Seguimiento_htmx_list")
