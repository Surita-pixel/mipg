    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('planes_proceso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Planes.planproceso')),
            ],
        ),
        migrations.CreateModel(
            name='TipoPlan',
            fields=[
                ...
                ('plan_proceso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Planes.planproceso')),
                ('planes_especificos', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Planes.tipoplanespecifico')),
            ],
        ),
        migrations.CreateModel(
